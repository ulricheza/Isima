package fr.isima.jsf;

import fr.isima.entity.Personne;
import fr.isima.jsf.util.JsfUtil;
import fr.isima.jsf.util.PaginationHelper;
import fr.isima.bean.PersonneFacade;
...
public class PersonneController implements Serializable {
    ...
    @EJB
    private fr.isima.bean.PersonneFacade ejbFacade;
    ...
    public Personne getSelected() {
        if (current == null) {
            ...
            current.setPersonnePK(new fr.isima.entity.PersonnePK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class PersonneControllerConverter implements Converter {
        ...
        fr.isima.entity.PersonnePK getKey(String value) {
            fr.isima.entity.PersonnePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new fr.isima.entity.PersonnePK();
            key.setPrenom(values[0]);
            key.setNom(values[1]);
            return key;
        }

        String getStringKey(fr.isima.entity.PersonnePK value) {
            StringBuffer sb = new StringBuffer();
            sb.append(value.getPrenom());
            sb.append(SEPARATOR);
            sb.append(value.getNom());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Personne) {
                ...
                return getStringKey(o.getPersonnePK());
            } else {
