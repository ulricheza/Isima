...
${OBJECTDIR}/cercle.h.gch: cercle.h 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o $@ cercle.h

${OBJECTDIR}/objetgraphique.o: objetgraphique.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/objetgraphique.o objetgraphique.c
