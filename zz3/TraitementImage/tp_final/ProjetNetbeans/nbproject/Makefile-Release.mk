...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetnetbeans: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetnetbeans ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/ClusteringSpatioTemporel.o: ClusteringSpatioTemporel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ClusteringSpatioTemporel.o ClusteringSpatioTemporel.cpp
