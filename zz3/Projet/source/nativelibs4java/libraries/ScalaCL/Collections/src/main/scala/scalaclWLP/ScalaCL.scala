...
package object scalaclWLP {
  ...
  private[scalaclWLP] def executingScalaFallbackOperation(opName: => String) = {
  ...
  private[scalaclWLP] def reuse[T](value: Any, create: => T): T =
