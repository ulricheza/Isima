...
/**
 * @author badqiu
 * @see http://rapid-framework.googlecode.com/svn/trunk/rapid-framework/src/rapid_framework_common/cn/org/rapid_framework/web/tags/BlockTag.java
 */
public class BlockTag extends TagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        try {
            ...
            throw new JspException("write overrided content error for block name:" + name, e);
        }
