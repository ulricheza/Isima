...
/*
 * OpenGL TP3 : Transparence d'objet
 */
#include <GL/gl.h>
#include <GL/glut.h>
#include <stdio.h>
...
static int displayTransparence = GL_TRUE; /* Affichage de la transparence */
static int displayColorMat = GL_FALSE;    /* Utilisation de la couleur des sommets */
enum moves displayFace=GL_BACK;           /* Face a  éliminer          */
...
static GLfloat couleur_plateau[] = {0.2, 0.4, 0.15, 0.5}; /* Couleur du dessus de table */
static GLfloat couleur_pied[] = {0.3, 0.3, 0.3, 1.0};     /* Couleur des pieds de table */
...
void display(void)
{
	GLfloat colorSol[]={0.6, 0.0, 0.0, 1.0};
